...
<Steps>
  ...
  <Step title="Processing">
    Connectors clean, format, and structure retrieved data into a personal index, a specialized <Tooltip tip="A structured representation of data that shows the relationships between different entities.">knowledge graph</Tooltip> optimized for Personal AI.
  </Step>
