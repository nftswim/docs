A Personal Index is a private, always-updating knowledge graph stored on your device. It organizes your personal data—like notes, messages, and files—so your Personal AI can better understand your habits, preferences, and context, all while keeping your data secure on your phone.

Key features of indexing include:

- **Smarter Personalization**: Your AI Agent recognizes your patterns and context to serve you better.
- **Privacy**: Data stays on your device, not on external servers.
- **Continuous Improvement**: As your life evolves, your Personal Index keeps pace.
