...
---
Guardian of data (God) Models are specialized validation models deployed within Trusted Execution Environments (TEEs) across the PIN AI Network. They serve as an oversight layer (hence "God"), continuously evaluating the performance of Personal AIs to ensure accuracy, consistency, and alignment with user data.
...
![Personal AI Protocol God-Models](/images/Doc-God-Model3.png)
...
The scoring function reflects how effectively the Personal AI delivers user-specific contextual information to an external AI agent, enabling it to accurately fulfill the user’s request. It is based on the following parameters:
...
<Note>
$Total Score = \sum \left( Weight_i \times \frac{Number\_of\_correct\_responses_i}{Number\_of\_questions_i} \right)
\div Normalizing\_Factor$
