...
<Steps>
  <Step title="Initialization">
    When a Personal AI is deployed locally on the user’s device and registered in the PIN AI Network, including:
    <ul>
  ...
  <Step title="Response verification">
    The Personal AI responds to queries referencing user data. The God Model checks the response against verified data logs or previously stored state (where possible) to assess how effectively the Personal AI delivers user-specific contextual information to an external Personal AI Agent.
  </Step>
