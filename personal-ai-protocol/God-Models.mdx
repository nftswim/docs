---
title: 'Overview'
description: 'What are God Models?'
---
...
- **KYC-based user validation**: Users must prove they are real individuals to access full benefits. Various KYC levels (e.g., World ID, transaction history, biometric verification) determine reward eligibility and score growth potential.
