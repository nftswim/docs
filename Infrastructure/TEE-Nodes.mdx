...
<div class="my-4 px-5 py-4 overflow-hidden rounded-2xl flex gap-3 border border-sky-500/20 bg-sky-50/50 dark:border-sky-500/30 dark:bg-sky-500/10">
    ...
    <div class="dark:text-gray-300">PIN AI currently supports only Intel SGX (Software Guard Extension) as the TEE hardware and will soon support Intel TDX and NVIDIA GPU TEE. <a href="https://sgx101.gitbook.io/sgx101/sgx-bootstrap/overview">Click here for more info about SGX</a>.</div>
</div>
