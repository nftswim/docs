...
<Note>PIN AI currently supports only Intel SGX (Software Guard Extension) as the TEE hardware and will soon support Intel TDX and NVIDIA GPU TEE. <a href="https://sgx101.gitbook.io/sgx101/sgx-bootstrap/overview">Click here for more info about SGX</a>.</Note>
