...
To run a Data Connector service in the PIN Network, Operators must stake PIN AI network tokens as collateral to ensure integrity and accountability. This aligns the economic interests of Operator with the network's goals. Key aspects include:
...
3. The Slash Manager checking on-chain events/records emitted by Data Connectors.
...
Operators are rewarded PIN AI tokens for delivering data services and maintaining the reliability and efficiency of the data pipeline infrastructure within the PIN AI ecosystem. Rewards are task-dependent, varying based on the complexity, type, and value of the data service delivered by the Operator.